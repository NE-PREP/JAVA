  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response?.status == 200) {
        ...
        errorToast(response?.message || "Error occurred while logging in");
        setLoading(false);
      }
    } catch (error) {
      setLoading(false);
    ...
    <div className="pb-12">
      ...
      <div className="flex flex-col items-center mt-8 border w-full md:w-[35vw] mx-auto py-8 px-16">
        ...
        <p className="text-xs font-light text-gray-400 mb-8">
          To start shopping in Kalim's Binary Supermarket, you need to login.
        </p>
        ...
        <p className="mt-4 text-sm">
          ...
          <Link to="/register" className="text-[#2272C3] font-bold">
            Signup
          </Link>
          .
        </p>
